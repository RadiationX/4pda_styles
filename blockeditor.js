...
*/
function elem(){
        var el=document.querySelectorAll('input[type=text], textarea, select');var e, n, v,o=[];for(var i=0;i<el.length;i++){e = el[i];n = e.getAttribute('name');v = e.value;o.push(n,{v});}console.log(JSON.stringify(jsonObj));
    }
